<%@ Page Title="" Language="C#" MasterPageFile="~/Hotel.Master" AutoEventWireup="true" CodeBehind="ExecutiveRoom.aspx.cs" Inherits="HotelBookingSystem.WebForm2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <div class="content">
            <p>This is a placeholder for the Executive Room description.</p>
            <p>Features:</p>
            <ul>
                <li>Feature 1</li>
                <li>Feature 2</li>
